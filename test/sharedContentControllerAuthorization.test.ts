...
const webControllers: Array<[string, Controller]> = [
    ...
    ['create Organization', createOrganizationWeb],
    ['create Organization release', createOrganizationReleaseWeb],
    ['update Organization', updateOrganizationWeb],
    ['delete Organization', deleteOrganizationWeb],
    ['add Catalog Credit', addCatalogCreditWeb],
    ['remove Catalog Credit', removeCatalogCreditWeb],
    ['reorder Catalog Credit', reorderCatalogCreditWeb],
    ['update Catalog Credit role', updateCatalogCreditRoleWeb],
    ['mark attribution unknown', markCatalogAttributionUnknownWeb],
    ['create Artist', createArtistWeb],
    ['update Artist', updateArtistWeb],
    ['update Artist metadata', updateArtistMetadataWeb],
    ['update Artist cover art', updateArtistCoverArtWeb],
    ['delete Artist', deleteArtistWeb],
    ['create Album', createAlbumWeb],
    ['create Album for Artist', createArtistAlbumWeb],
    ['create Artist release workflow', createArtistReleaseWorkflowWeb],
    ['retry Artist release workflow', retryArtistReleaseWorkflowWeb],
    ...
    ['add Album to Artist', addArtistAlbumWeb],
    ['remove Album from Artist', removeArtistAlbumWeb],
