...
// Create a post
router.post('/post', requireAuth, requireAdmin, createPostValidation, asyncHandler(feedController.createPost));

// Delete a post
router.delete('/post', requireAuth, requireAdmin, asyncHandler(feedController.deletePost));
