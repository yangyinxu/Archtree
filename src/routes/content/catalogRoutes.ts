...
router.put('/album/:albumId', requireAuth, requireAdmin, uploadConcurrencyLimit, requireUploadSize(maxImageUploadMb + 1), imageUpload.single('coverArtFile'), asyncHandler(albumController.updateAlbum));
...
router.post('/artist', requireAuth, requireAdmin, uploadConcurrencyLimit, requireUploadSize(maxImageUploadMb + 1), imageUpload.single('coverArtFile'), asyncHandler(artistController.postArtist));
router.put('/artist/:artistId', requireAuth, requireAdmin, uploadConcurrencyLimit, requireUploadSize(maxImageUploadMb + 1), imageUpload.single('coverArtFile'), asyncHandler(artistController.updateArtist));
