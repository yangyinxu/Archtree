...
export const findIncompleteAudioTracks = (
    ...
    .map((track) => ({
        ...
        s3VersionId: track.mediaRepresentation?.objectKey === track.s3Key
        ...
        pendingUploadOutcomeUnknown: track.pendingUploadOutcomeUnknown === true,
